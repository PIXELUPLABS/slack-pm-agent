...
const SUGGESTED_PROMPTS = [
  { title: "What's on my plate today?", message: "What's on my plate today?" },
  { title: 'Add a task from a client message', message: 'Add a task from a client message' },
  { title: 'Status of [project]', message: 'Status of [project]' },
];
